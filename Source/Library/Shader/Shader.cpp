...
namespace library
{
    ...
    HRESULT Shader::compile(_Outptr_ ID3DBlob** ppBlobOut)
    {
        HRESULT hr = S_OK;
        ...
        hr = D3DCompileFromFile(m_pszFileName, nullptr, nullptr, m_pszEntryPoint, m_pszShaderModel, dwShaderFlags, 0, ppBlobOut, pErrorBlob.GetAddressOf());
