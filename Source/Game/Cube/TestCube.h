...
/*C+C+++C+++C+++C+++C+++C+++C+++C+++C+++C+++C+++C+++C+++C+++C+++C+++C
  ...
  Methods:  Initialize
            ...
            ~BaseCube
              Destructor.
C---C---C---C---C---C---C---C---C---C---C---C---C---C---C---C---C-C*/
class TestCube : public BaseCube
{
public:
    TestCube() = default;
    TestCube(const TestCube& other) = delete;
    TestCube(TestCube&& other) = delete;
    TestCube& operator=(const TestCube& other) = delete;
    TestCube& operator=(TestCube&& other) = delete;
    ~TestCube() = default;
