...
INT WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ INT nCmdShow)
{
    ...
    if (FAILED(game->GetRenderer()->SetVertexShaderOfRenderable(L"TestCube",L"MainShader")))
    {
        return 0;
    }
    if (FAILED(game->GetRenderer()->SetPixelShaderOfRenderable(L"TestCube",L"MainShader")))
    {
        return 0;
    }
